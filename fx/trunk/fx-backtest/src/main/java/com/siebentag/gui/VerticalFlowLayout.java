...
public class VerticalFlowLayout implements LayoutManager2
{
   ...
   /**
	* The vertical distance separating components added.
	*/
   int VGap = 0;
	...
	* Constructor
	*
	* @param vGap The vertical gap between components added.
	*/
	...
	* @param vGap The vertical gap between components added.
	*/
   public VerticalFlowLayout( int vGap, int allign )
   {
	   VGap = vGap;
	   Allignment = allign;
   }
   ...
   /**
	* Adds a component to the layout by name. This method is irrelevant
	* to this layout as names are not used.
	*
   ...
   /**
	* Do the laying out of the components. Sets the size and position
	* of all components in the layout.
	*
   ...
   /**
	* Retrieve the X allignment priority.
	*
	* @param target The container that the layout is working on.
	* @return The X Allignment priority.
	*/
   ...
   /**
	* Retrieve the Y allignment priority.
	*
	* @param target The container that the layout is working on.
	* @return The Y Allignment priority.
	*/
