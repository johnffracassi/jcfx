...
public class BackTester 
{
	...
	public void run()
	{
		try
		{
			FXDataResponse<CandleDataPoint> candles = dataManager.loadCandles(new FXDataRequest(FXDataSource.GAIN, Instrument.AUDUSD, new LocalDate(2009,6,8), Period.FifteenMin));
