...
public class NewPriceChartEvent implements FXActionEvent {
	...
	public NewPriceChartEvent(Instrument instrument, FXDataSource dataSource, Period period, LocalDate startDate, LocalDate endDate) {
