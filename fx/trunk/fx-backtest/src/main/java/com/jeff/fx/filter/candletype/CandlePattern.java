...
public enum CandlePattern
{
    ...
    BlackMarabozu(new CandlePatternEvaluator() {public boolean evaluate(CandleDataPoint dp) {return blackMarubozu.is(dp); }}),
    WhiteMarabozu(new CandlePatternEvaluator() {public boolean evaluate(CandleDataPoint dp) {return whiteMarubozu.is(dp); }}),
