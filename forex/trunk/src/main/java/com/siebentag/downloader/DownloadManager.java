...
import com.siebentag.fx.source.gain.GainDownloader;

// The Download Manager.
public class DownloadManager extends JFrame implements Observer
{
    private static final long serialVersionUID = 5285747505861172804L;
	...
	private JButton cancelButton, clearButton, gainButton;
	...
	public DownloadManager()
	{
		...
		gainButton = new JButton("Add GAIN");
		gainButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)	{
				GainDownloader gd = new GainDownloader();
				List<String> urls = gd.generateUrls();
				for(String url : urls)
				{
	...
	private void clearDownload(Download download)
	{
		clearing = true;
		tableModel.clearDownload(download);
		clearing = false;
		selectedDownload = null;
		updateButtons();
	}
	...
	public void update(Observable o, Object arg)
	{
		if(o instanceof Download)
		{
			...
			if(dl.getStatus() == DownloadStatus.Complete)
			{
				primeQueue();
			}
		}
